...
import { ArrowRight, Building2, UserRoundCog, UsersRound, WalletCards } from "lucide-react";
...
const links = [["School setup", "/dashboard/school-admin/setup", Building2], ["Students", "/dashboard/school-admin/students", UsersRound], ["Staff", "/dashboard/school-admin/staff", UserRoundCog], ["Finance", "/dashboard/school-admin/finance", WalletCards]] as const;

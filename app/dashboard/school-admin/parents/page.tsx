...
export default async function ParentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ModuleImportActions title="Import parents and guardians" description="Add guardian contacts or connect existing guardians to students." module="guardians" secondary={{ label: "Import student-guardian links", module: "guardian-links" }} />
